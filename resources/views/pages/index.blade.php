...
@include('layouts.menubar')
                    ...
                    <div class="deals">
                        ...
                        <div class="deals_slider_container">
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    ...
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            ...
                                            <div class="deals_item_price_a ml-auto">Rs.5000</div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">Brothermart Black Printed Kurti With Pant and Shawl Exclusive Sale</div>
                                            <div class="deals_item_price ml-auto">Rs.2000</div>
                                        </div>
                                        <div class="available">
                                ...
                                <!-- Deals Item -->
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset('public/frontend/images/deals2.png')}}" alt=""></div>
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            
                                            <div class="deals_item_price_a ml-auto">Rs.4500</div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">Comfortable Breathable Shoes Sneakers For Men</div>
                                            <div class="deals_item_price ml-auto">Rs.2950</div>
                                        </div>
                                        <div class="available">
                                            <div class="available_line d-flex flex-row justify-content-start">
                                                <div class="available_title">Available: <span>6</span></div>
                                ...
                                <!-- Deals Item -->
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset('public/frontend/images/deals3.jpg')}}" alt=""></div>
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            
                                            <div class="deals_item_price_a ml-auto">Rs.2500</div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">NAVIFORCE Nf9074 Sports Black Dial Analog Watch For Men - Brown</div>
                                            <div class="deals_item_price ml-auto">Rs.1700</div>
                                        </div>
                                        <div class="available">
                                            <div class="available_line d-flex flex-row justify-content-start">
                                                <div class="available_title">Available: <span>6</span></div>
    ...
    <div class="trends">
        <div class="trends_background" style="background-color: #eff6fa;"></div>
