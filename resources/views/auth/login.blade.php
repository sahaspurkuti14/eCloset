...
<div class="contact_form" style="background-color:#DFFDEA;">
        <div class="container" >
            <div class="row">
                <div class="col-lg-5 offset-lg-1" style="border: 1px solid grey; padding: 20px; border-radius: 25px; background-color:#D8E4FF; box-shadow: 10px 10px 14px 0px rgba(0,0,0,0.41); ">
    ...
    <input type="password" class="form-control @error('password') is-invalid @enderror"  aria-describedby="emailHelp" name="password" required="">
            ...
            <a href="{{ url('/auth/redirect/facebook') }}" class="btn btn-primary btn-block"><i class="fab fa-facebook-square"></i> Login with Facebook </a>
